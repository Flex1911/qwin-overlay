...
# $Header: /var/cvsroot/gentoo-x86/x11-drivers/nvidia-drivers/nvidia-drivers-346.22.ebuild,v 1.3 2014/12/12 09:45:25 jer Exp $
...
IUSE="acpi multilib kernel_FreeBSD kernel_linux pax_kernel +tools gtk2 gtk3 +X uvm git_kernel"
REQUIRED_USE="
	tools? ( X || ( gtk2 gtk3 ) )
"
